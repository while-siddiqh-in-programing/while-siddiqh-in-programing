...
**AI Intern** – *Infosys Springboard* (Oct 2024 – DEC 2024)  
- Built a full working platform for summaraizing Text, Document, etc...
- Developed a **Streamlit** interface for switching between models and select the output length.  
